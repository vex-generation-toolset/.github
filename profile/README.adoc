...
https://github.com/vex-generation-toolset/callgraph-metadata[Metadata database]::
Provides a *sample metadata dataset* containing precomputed CVE root causes and call graphs for dependencies used by https://solr.apache.org/[Apache Solr].
